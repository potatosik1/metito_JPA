...
insert into patient (id, first_name, last_name, telephone_number, email, patient_number, date_of_birth, is_foreigner, version)
            values(102, 'Karol', 'Nowak', '+481234565789', 'karoln@email.com', '123','2000-12-12', true, 1);

insert into visit (id, description, time, patient_id, doctor_id)
            values(103, 'opis', '2000-12-12 12:00:00', 102, 101);

insert into visit (id, description, time, patient_id, doctor_id)
            values(104, 'opis 2', '2000-12-12 12:00:00', 102, 101);

insert into medical_treatment(id, description, type, visit_id)
            values(105, 'opis', 'USG', 103);

insert into medical_treatment(id, description, type, visit_id)
            values(106, 'opis', 'EKG', 104);
